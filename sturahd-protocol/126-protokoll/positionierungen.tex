\section{Diskussionen, Inhaltliche Positionierungen}
    ...
    \antrag{ heiConf für alle Studierenden öffnen \label{dis:heiConf}}{zurückgezogen}{Liste GHG}{
    ...
    \diskussion{Öffentliche Beratung über den Stand der geplanten Fuß- und Radbrücke über den Neckar}{1. Lesung}{}{
...
\section{Beschlüsse der Sondersitzung}
    \antrag{Lernräume und -orte \label{corona:1}}{1. Lesung}{Antragsstellend}
    {
        ...
        \aenderungsantrag{\autoref{corona:1}\label{corona:1.1}}{Grüne Hochschulgruppe Heidelberg }{
        \myparagraph{mehr Transparenz}
        Wir fordern transparente, verständlichere und rechtzeitige Auskunft über den
        aktuellen
        Studienbetrieb. Zusätzlich zu den Informationen auf der Uni Website fordern wir
        ...
        kann.
        \myparagraph{Virtuelle Räume für Online-Lerngruppen}
        \replace{Wir fordern, dass alle Studierenden über die bereits auf der Stura-Webseite
        ...
        sollte durch
        die Einrichtung einer Universitätsplattform für alle Studierende gelöst werden.}{Der StuRa drängt die Universität und das Universitätsrechenzentrum, allen Studierenden die Einrichtung von Räumen in heiConf zu ermöglichen. 
        }
        \myparagraph{Druckerzugang}
        Der StuRa fordert, dass alle Studierende einen Zugang zu Instituts- und
        Bibliotheksdruckern
        ...
        \GOantrag{Dringlichkeit für \ref{corona:1}\label{corona:1.2}}{
        Für die Anträge soll auf die 2. Lesung verzichtet werden.
        }{
            Die für Klausuren relevanten Positionierunge müssen vor den Klausuren beschlossen werden, um noch Verbesserungen zu erzielen.
        }{
            Keine Gegenrede.
        }{
            \abstimmungsergebnis{
    ...
    \aenderungsantrag{\autoref{corona:2}\label{corona:2.1}}{}{
        ...
        und
        Bücher der Fachbibliotheken eingescannt Student*innen und Dozent*innen zur
        Verfügung zu stellen. \replace{Dabei können Wochen- oder Monatslimits (z.B. fünf Aufsätze oder
        ...
        noch Kapazitäten vorhanden sind.\\}{
            Alle Bibliotheken, auch Fachspezifische und Fakultätsbibliotheken sollen verpflichtend den Studierenden Möglichkeiten des Scans und der Ausleihe per Abholung zur Verfügung stellen, auch in Präsenzbibliotheken.\\
            Das Inanspruchnehmen dieser Services soll fakultätsübergreifend sein, Studierende aller Fachrichtungen sollen die Möglichkeit haben, auch fachfremde Literatur auszuleihen.\\
            Die Limits sollen von den einzelnen Bibliotheken selbst festgelegt werden, je nach Nachfrage und Kapazitäten.\\
            Um die Kapazitäten zu erhöhen ist die Universität dazu angehalten, mehr Mitarbeitende einzustellen.\\
            Die Ausleihe per Abholung soll so möglich sein, dass die Studierenden und Mitglieder der Universität die Räume betreten und, unter Einhaltung der Hygienevorschriften, die Bücher selbst ausssuchen können.\\
        ...
        \abstimmungsergebnis{
            ...
            \ul{\noli{\ul{\lii{Vom Antragssteller angenommen}}}}
        }
    }
    \GOantrag{Dringlichkeit für \ref{corona:2}\label{corona:2.2}}{
        Für die Anträge soll auf die 2. Lesung verzichtet werden.
        }{
            Die für Klausuren relevanten Positionierunge müssen vor den Klausuren beschlossen werden, um noch Verbesserungen zu erzielen.
        }{
    ...
    \antrag{Corona-Freischuss! \label{corona:3}}{1. Lesung}{Antragsstellend}
    {
        ...
        \aenderungsantrag{\autoref{corona:3} \label{corona:3.1}}{}{
            ...
            \subsubsection{Englisch/ internationale Studierenden/ mehr Zeit für Prüfungen \label{corona:3.2} (1. Lesung)}
            Antragsstellend: 
        ...
        %1titel,2lesung,3antragssteller,4antragstext,5begründung,6diskussion,7abstimmung
        \subsubsection{Mehr Zeit für Jura  \label{corona:3.3} (1. Lesung)}
        Antragsstellend: 
        \myparagraph{Antragstext:}
            Die Verfasste Studierendenschaft der Ruprecht-Karls-Universität Heidelberg fordert,
            das
        ...
        \textbf{1. Lesung:}
        \ul{
            \li{Durch \url{https://www.justiz-bw.de/site/pbs-bw-rebrush-jum/get/documents_E1441090213/jum1/JuM/Justizministerium\%20NEU/Pr\%C3\%BCfungsamt/Hinweise\%20zur\%20Staatspr\%C3\%BCfung\%20in\%20der\%20Ersten\%20juristischen\%20Pr\%C3\%BCfung/Hinweis\%20Homepage\%20Coronavirus\%202019-01-21.pdf} ist der Antrag obsolet. }
        }
        \myparagraph{Abstimmung:}
        \abstimmungsergebnis{
            \fullref{corona:3.3}
        ...
        %1titel,2lesung,3antragssteller,4antragstext,5begründung,6diskussion,7abstimmung
        \subsubsection{Freischuss für Medizin \label{corona:3.4} (1. Lesung)}
        Antragsstellend: 
        \myparagraph{Antragstext:}
            Die Verfasste Studierendenschaft der Ruprecht-Karls-Universität Heidelberg fordert,
            dass alle
        ...
        \GOantrag{Dringlichkeit für \ref{corona:3}, \ref{corona:3.2}, \ref{corona:3.3}\label{corona:3.5}}{
        Für die Anträge soll auf die 2. Lesung verzichtet werden.
        }{
            Die für Klausuren relevanten Positionierunge müssen vor den Klausuren beschlossen werden, um noch Verbesserungen zu erzielen.
        }{
    ...
    \antrag{Klausurenphase \label{corona:4}}{1. Lesung}{Antragsstellend}
    {
        ...
        \GOantrag{Dringlichkeit für \ref{corona:4}\label{corona:4.2}}{
        Für die Anträge soll auf die 2. Lesung verzichtet werden.
        }{
            Die für Klausuren relevanten Positionierunge müssen vor den Klausuren beschlossen werden, um noch Verbesserungen zu erzielen.
        }{
    ...
    \antrag{Qualität der digitalen Lehre \label{corona:7}}{1. Lesung}{Antragsstellend}
    {
        ...
        \aenderungsantrag{\autoref{corona:7}\label{corona:7.1}}{}{
    ...
    \antrag{Mensa-Essen \label{corona:8}}{1. Lesung}{Antragsstellend}
    {
        ...
        \aenderungsantrag{\autoref{corona:8}\label{corona:8.1}}{}{
            Der StuRa spricht dem Studierendenwerk seinen Dank für die Einrichtung eines Corona-
            konformen
            und sicheren Mensabetriebes durch To-Go-Angebote und die Einführung eines festen
            Tagesgerichts
    ...
    \GOantrag{Dringlichkeit für \ref{corona:9}\label{corona:9.1}}{
        Für die Anträge soll auf die 2. Lesung verzichtet werden.
        }{
            Die für Klausuren relevanten Positionierunge müssen vor den Klausuren beschlossen werden, um noch Verbesserungen zu erzielen.
        }{
