...
\finanzantrag{Collegium Musicum Heidelberg}{Collegium Musicum Heidelberg}
{
...
{
    \textbf{1. Lesung:}\\
    Stura hat schon öfters den Druck finanziert, bekommt edr Stura eine Ausgabe davon?
        können gerne auch eine an Stura schicken, Stura hat Druck die letzen jahre teilfinanziert, stura wird auch im koba erwähnt
}
\finanzantrag{Weihnachtsgesteck}{Fachschaft Germanistik}
{
